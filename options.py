...
parser.add_argument('--de_type', nargs='+', default=['denoise_15', 'denoise_25', 'denoise_50', 'derain', 'dehaze' , 'vad'],
...
parser.add_argument('--vad_dir' , type = str , default = 'data/Train/vad' , help ='frames of shanghai_dataset')
parser.add_argument('--output_path', type=str, default="output/", help='output save path')
parser.add_argument('--ckpt_path', type=str, default="ckpt/vad/shanghai", help='checkpoint save path')
